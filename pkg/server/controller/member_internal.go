...
func NewMemberControllerForInternal(memberRepository repository.MemberRepository) MemberControllerForInternal {
	return &memberControllerForInternal{ MemberRepository: memberRepository}
}